...
{
    /**
     * IgbinaryComponentRegistrar constructor.
     */
    ...
    {
        $this->di->bind(IgbinaryTranslator::class, IgbinaryTranslator::class);
        $this->di->bind(IgbinaryTranslatorInterface::class, IgbinaryTranslator::class);
    }
}
